...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>TechStop - Admin Dashboard</title>
    <link
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul class="mt-6">
            ...
            <li class="relative px-6 py-3">
              ...
              <a
                wire:navigate
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.messages') ? 'text-gray-800 dark:text-gray-100' : '' }}"
            ...
            <li class="relative px-6 py-3">
              ...
              <a
                wire:navigate
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->routeIs('admin.blogs') ? 'text-gray-800 dark:text-gray-100' : '' }}"
