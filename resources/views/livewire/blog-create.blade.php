<div>
<form wire:submit.prevent="saveBlog" class="space-y-8">
    <!-- Basic Information -->
    ...
    <div class="space-y-6 mb-8">
        <div>
            ...
            <textarea id="excerpt" name="excerpt" autocomplete="off" wire:model="excerpt" rows="4" class="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" placeholder="Brief description of the blog post"></textarea>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div>
            ...
            @if($featured_image)
                <div class="mt-4">
                    <img src="{{ $featured_image->temporaryUrl() }}" class="h-40 w-40 object-cover rounded-lg border">
                </div>
            @endif
        </div>
        ...
        <div>
            ...
            <input id="published_at" name="published_at" autocomplete="off" type="datetime-local" wire:model="published_at" class="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
    ...
    <div class="mb-8">
        ...
        <select id="selectedTags" name="selectedTags[]" autocomplete="off" multiple wire:model="selectedTags" class="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" size="6">
            @foreach($tags as $tag)
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div class="lg:col-span-2">
            ...
            <input id="meta_title" name="meta_title" autocomplete="off" type="text" wire:model="meta_title" class="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" placeholder="SEO title">
        ...
        <div class="lg:col-span-2">
            ...
            <textarea id="meta_description" name="meta_description" autocomplete="off" wire:model="meta_description" rows="3" class="w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white" placeholder="SEO description"></textarea>
    ...
    <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
        <a href="{{ route('admin.blogs') }}" wire:navigate class="px-6 py-3 bg-gray-500 text-accent rounded-lg hover:bg-gray-600 transition-colors">
            Cancel
        </a>
        <button type="submit" class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors" wire:loading.attr="disabled" wire:loading.class="opacity-50">
            <span wire:loading.remove>Create Blog</span>
            <span wire:loading><i class="fas fa-spinner fa-spin mr-2"></i>Creating...</span>
        </button>
    </div>
</form>
